...
// Unused space has been moved into DATA from FOOTER
// This gives an extra 116 bytes in SaveBlock2, an extra 464 bytes in SaveBlock1, and an extra 1044 bytes in PokemonStorage
